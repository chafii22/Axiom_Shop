...
// Fix: Use $_SESSION instead of $SESSION
...
<div class="fixed bottom-4 right-12 z-50 rounded-full px-4 py-4 bg-[#0f172a] text-white shadow-lg flex items-center transition-all duration-300 hover:shadow-xl">
    <?php if ($isLoggedIn): ?>
        ...
        <div class="flex items-center gap-3">
            ...
            <!-- Chat is in root directory -->
            <a href="<?php echo $root_path; ?>chat.php" class="p-2 hover:text-green-200 transition-colors" title="Chat">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                </svg>
            </a>
            
            <!-- Logout is in auth directory -->
